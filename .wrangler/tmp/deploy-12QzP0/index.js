...
class ReadStream extends Socket$1 {
  fd;
  constructor(fd) {
    super();
    this.fd = fd;
...
class WriteStream extends Socket$1 {
  fd;
  constructor(fd) {
    super();
    this.fd = fd;
...
const on = noop$2;
const addListener = noop$2;
const once = noop$2;
const off = noop$2;
const removeListener = noop$2;
const removeAllListeners = noop$2;
const emit = function emit2(event) {
  if (event === "message" || event === "multipleResolves") {
    return process$1;
  }
  return false;
};
const prependListener = noop$2;
const prependOnceListener = noop$2;
...
let _cwd = "/";
const cwd = function cwd2() {
  return _cwd;
};
const chdir = function chdir2(dir) {
  _cwd = dir;
};
const umask = function umask2() {
  return 0;
};
const getegid = function getegid2() {
  return 1e3;
};
const geteuid = function geteuid2() {
  return 1e3;
};
const getgid = function getgid2() {
  return 1e3;
};
const getuid = function getuid2() {
  return 1e3;
};
const getgroups = function getgroups2() {
  return [];
};
const getBuiltinModule$1 = (_name) => void 0;
const abort = notImplemented("process.abort");
const allowedNodeEnvironmentFlags = /* @__PURE__ */ new Set();
const arch = "";
const argv0 = "";
const config = empty;
...
const disconnect = noop$2;
const emitWarning = noop$2;
const eventNames = notImplemented("process.eventNames");
const execArgv = [];
const execPath = "";
const exit$1 = notImplemented("process.exit");
const features = /* @__PURE__ */ Object.create({
  inspector: void 0,
  debug: void 0,
  uv: void 0,
  ipv6: void 0,
...
const getMaxListeners = notImplemented(
...
const platform$1 = "";
const ppid = 1e3;
const rawListeners = notImplemented(
  "process.rawListeners"
);
const release = /* @__PURE__ */ Object.create({
  name: "",
  lts: "",
  sourceUrl: void 0,
  headersUrl: void 0
});
const report = /* @__PURE__ */ Object.create({
  compact: void 0,
  directory: void 0,
  filename: void 0,
...
const resourceUsage = notImplemented(
...
const setMaxListeners = notImplemented(
...
const uptime = () => 0;
const exitCode = 0;
const setUncaughtExceptionCaptureCallback = notImplemented("process.setUncaughtExceptionCaptureCallback");
const hasUncaughtExceptionCaptureCallback = () => false;
const sourceMapsEnabled = false;
const loadEnvFile = notImplemented(
  "process.loadEnvFile"
);
...
const _linkedBinding = notImplemented("process._linkedBinding");
const domain = void 0;
const initgroups = notImplemented("process.initgroups");
const moduleLoadList = [];
const reallyExit = noop$2;
const _exiting = false;
const _events = [];
const _eventsCount = 0;
const _maxListeners = 0;
const process$1 = {
  // @ts-expect-error
  _events,
  _eventsCount,
...
const getBuiltinModule = unpatchedGlobalThisProcess.getBuiltinModule;
const workerdProcess = getBuiltinModule("node:process");
const { env, exit, nextTick, platform } = workerdProcess;
const _process = {
  /**
...
class _Performance {
  ...
  navigation = _times.__createMock__("PerformanceNavigation");
  timing = _times.__createMock__("PerformanceTiming");
  ...
  measure(measureName, startOrMeasureOptions, endMark) {
    ...
    if (typeof startOrMeasureOptions === "string") {
      ...
      start = Number.parseFloat(startOrMeasureOptions?.start) || performance$2.now();
      end = Number.parseFloat(startOrMeasureOptions?.end) || performance$2.now();
    }
...
const performance$2 = globalThis.performance || new Performance();
...
_global.performance = _global.performance || performance$2;
...
const var_performance = _global.performance;
const _stdoutErrorHandler = Object.assign(() => {
}, { __unenv__: true });
const _console = globalThis.console;
const _ignoreErrors = true;
const _stderr = new Writable();
const _stdout = new Writable();
_console?.createTask ?? notImplemented("console.createTask");
notImplemented("console.assert");
const Console = _console?.Console ?? _times.__createMock__("console.Console");
const workerdConsole = globalThis["console"];
Object.assign(workerdConsole, {
  Console,
  _ignoreErrors,
  _stderr,
  _stderrErrorHandler: _stdoutErrorHandler,
  _stdout,
  _stdoutErrorHandler,
  _times
});
...
class Builder extends NotTagged {
  ...
  build(before, parameters, types2, options) {
    const keyword = builders.map(([x, fn2]) => ({ fn: fn2, i: before.search(x) })).sort((a, b2) => a.i - b2.i).pop();
...
}).map(([x, fn2]) => [new RegExp("((?:^|[\\s(])" + x + "(?:$|[\\s(]))(?![\\s\\S]*\\1)", "i"), fn2]);
function notTagged() {
...
function createJsonTransform(fn2) {
  return function jsonTransform(x, column) {
    return typeof x === "object" && x !== null && (column.type === 114 || column.type === 3802) ? Array.isArray(x) ? x.map((x2) => jsonTransform(x2, column)) : Object.entries(x).reduce((acc, [k, v]) => Object.assign(acc, { [fn2(k)]: jsonTransform(v, column) }), {}) : x;
  };
}
...
function Connection(options, queues = {}, { onopen = noop$1, onend = noop$1, onclose = noop$1 } = {}) {
  ...
  function nextWrite(fn2) {
    const x = socket.write(chunk, fn2);
...
function Subscribe(postgres2, options) {
  ...
  function call(x, a, b2) {
    subscribers.has(x) && subscribers.get(x).forEach(({ fn: fn2 }) => fn2(a, b2, x));
  }
}
function Time(x) {
...
function Postgres(a, b2) {
  ...
  async function begin(options2, fn2) {
    ...
    async function scope(c, fn22, name) {
      const sql2 = Sql(handler2);
...
function parseOptions(a, b2) {
  if (a && a.shared)
    return a;
  const env2 = process.env, o = (!a || typeof a === "string" ? b2 : a) || {}, { url, multihost } = parseUrl(a), query = [...url.searchParams].reduce((a2, [b22, c]) => (a2[b22] = c, a2), {}), host = o.hostname || o.host || multihost || url.hostname || env2.PGHOST || "localhost", port = o.port || url.port || env2.PGPORT || 5432, user = o.user || o.username || url.username || env2.PGUSERNAME || env2.PGUSER || osUsername();
...
globalThis.performance = var_performance;
